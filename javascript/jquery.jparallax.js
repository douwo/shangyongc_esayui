...
jQuery.fn.jparallax.settings = {
  ...
  triggerExposesEdges:  false,          // Sets whether the trigger pulls layer edges into view in trying to centre layer content.
	...
	yparallax:				    true,						//
	xorigin:					    0.6,				    // Sets default alignment - only comes into play when travel is not 1
	yorigin:					    0,				    //
	xtravel:              0.1,              // Factor by which travel is amplified
	ytravel:              0.1,              //
	takeoverFactor:		    0.65,						// Sets rate of decay curve for catching up with target mouse position
	takeoverThresh:		    0.022,					// Sets the distance within which virtualmouse is considered to be on target, as a multiple of mouseport width.
	frameDuration:        10							// In milliseconds
};
